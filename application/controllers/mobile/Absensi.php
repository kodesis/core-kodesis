...
class Absensi extends CI_Controller
{
    ...
    public function absen_wfa()
    {
        ...
        if (strpos($a, '401') !== false) {
            ...
            $this->load->view('mobile/Layouts/v_header', $data);
            $this->load->view('mobile/absensi/v_absen_wfa', $data);
            $this->load->view('mobile/Layouts/v_footer');
        } else {
            $this->session->set_flashdata('forbidden', 'Not Allowed!');
            redirect('home');
    ...
    public function user_photo()
    {
        ...
        if (strpos($a, '401') !== false) {
            ...
            $this->load->view('mobile/Layouts/v_header', $data);
            $this->load->view('mobile/absensi/v_user_photo', $data);
            $this->load->view('mobile/Layouts/v_footer');
        } else {
            $this->session->set_flashdata('forbidden', 'Not Allowed!');
            redirect('home');
    ...
    //         $this->load->view('mobile/Layouts/v_header', $data);
    //         $this->load->view('mobile/userTable', $data);
    //         $this->load->view('mobile/Layouts/v_footer');
    //     } else {
    //         $this->session->set_flashdata('forbidden', 'Not Allowed!');
    //         redirect('home');
    ...
    public function absen_list()
    {
        ...
        if (strpos($a, '401') !== false) {
            ...
            $this->load->view('mobile/Layouts/v_header', $data);
            $this->load->view('mobile/absensi/v_absensi_list', $data);
            $this->load->view('mobile/Layouts/v_footer');
        } else {
            $this->session->set_flashdata('forbidden', 'Not Allowed!');
            redirect('home');
