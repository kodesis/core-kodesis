...
class App extends CI_Controller
{
    ...
    public function inbox()
    {
        ...
        if (strpos($a, '401') !== false) {
            ...
            $this->load->view('mobile/memo/v_inbox', $data);
    ...
    public function memo_pdf($id)
    {
        ...
        if (strpos($a, '401') !== false) {
            ...
            $this->load->view('mobile/memo/v_memo_pdf', $data);
            // $this->load->view('mobile/cetak_form_cuti', $data);
            // $dompdf = new Dompdf\Dompdf();
            // $dompdf->loadHtml($this->load->view('mobile/memo_pdf', $data, true));
    ...
    public function create_memo()
    {
        ...
        if (strpos($a, '401') !== false) {
            ...
            $this->load->view('mobile/Layouts/v_header', $data);
            $this->load->view('mobile/memo/v_create', $data);
            $this->load->view('mobile/Layouts/v_footer');
        } else {
            $this->session->set_flashdata('forbidden', 'Not Allowed!');
            redirect('mobile/home');
    ...
    public function outbox()
    {
        ...
        if (strpos($a, '401') !== false) {
            $search = htmlspecialchars($this->input->get('search') ?? '', ENT_QUOTES, 'UTF-8');
            // Pagination
            $config['base_url'] = base_url('mobile/app/outbox');
            ...
            $this->load->view('mobile/Layouts/v_header', $data);
            $this->load->view('mobile/memo/v_outbox', $data);
            $this->load->view('mobile/Layouts/v_footer');
        } else {
            $this->session->set_flashdata('forbidden', 'Not Allowed!');
            redirect('mobile/home');
    ...
    public function user()
    {
        ...
        if (strpos($a, '401') !== false) {
            ...
            $this->load->view('mobile/Layouts/v_header', $data);
            $this->load->view('mobile/absensi/v_user_list', $data);
            $this->load->view('mobile/Layouts/v_footer');
        } else {
            $this->session->set_flashdata('forbidden', 'Not Allowed!');
            redirect('mobile/home');
    ...
    public function absen_wfa()
    {
        if ($this->session->userdata('isLogin') == FALSE) {
            ...
            $this->load->view('mobile/absen_wfh_view', $data);
        }
    }
    public function fetch_user()
    {
        ...
        if ($users) {
            ...
            if (!$hasPicture) {
                ...
                $data['users'] = $users;
                $tableHTML = $this->load->view('mobile/userTable', $data, TRUE);
        ...
        if ($this->session->userdata('isLogin') == FALSE) {
            ...
            if (strpos($a, '401') !== false) {
                ...
                if (empty($data['user'])) {
                    ...
                    $this->load->view('mobile/user_view_photo', $data);
                }
            }
        }
    }
