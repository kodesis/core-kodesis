...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['title'] = 'Login';
		$this->load->view('mobile/Auth/v_header', $data);
		$this->load->view('mobile/Auth/v_login');
		$this->load->view('mobile/Auth/v_footer');
	}
	...
	public function login()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if (empty($cek)) {
				...
				$this->session->set_userdata('nama_akronim', $setting->nama_singkat);
				redirect('mobile/home');
			} else {
				$this->session->set_flashdata('msg', '
                <div class="alert me-3 ms-3 rounded-s bg-red-dark " role="alert">
	...
	public function password()
	{
		...
		$this->load->view('mobile/Auth/v_password');
