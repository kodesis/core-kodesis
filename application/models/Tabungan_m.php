...
class Tabungan_m extends CI_Model
{
    ...
    var $column_order = array('no_tabungan', 'no_cib', 'jenis_tabungan', 'status_tabungan', 'no_urut', 'nominal', 'spread_rate', 'nominal_blokir', 'pos_rate', 'nolsp'); //set column field database for datatable orderable
    var $column_search = array('no_tabungan', 'no_cib', 'jenis_tabungan', 'status_tabungan', 'no_urut', 'nominal', 'spread_rate', 'nominal_blokir', 'pos_rate', 'nolsp'); //set column field database for datatable searchable
    ...
    function _get_datatables_query()
    {
        ...
        $this->cb->select('a.*, b.nama, c.nama_tabungan');
        $this->cb->from('t_tabungan as a');
        $this->cb->join('t_nasabah as b', 'b.no_cib = a.no_cib');
        $this->cb->join('t_jenistabungan as c', 'c.kode_tabungan = a.jenis_tabungan', 'LEFT');
    ...
    public function get_detail_id($id)
    {
        ...
        $this->cb->from('t_tabungan'); // Table name
    ...
    public function getLastNumber($jenis_tabungan)
    {
        ...
        $this->cb->limit(1);
        $result = $this->cb->get('t_tabungan')->row();
