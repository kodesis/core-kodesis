        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('depositwh/store_agent_deposit') ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select name="coa_agent" id="coa_agent_i" class="form-control select2-pic-coa">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("depositwh/getData_agents_deposit") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $('.select2-pic-coa').select2({
                placeholder: ':: Pilih Agent',
                allowClear: true,
                dropdownParent: $('#tambahCustomer .modal-content'),
                ajax: {
                    url: '<?= base_url("depositwh/get_coa") ?>', // Mengarah ke method controller baru
                    type: 'POST',
                    dataType: 'json',
                    delay: 250,
                    ...
                    processResults: function(data) {
                        return {
                            results: $.map(data, function(item) {
                                return {
                                    id: item.no_sbb,
                                    text: item.no_sbb + ' - ' + item.nama_perkiraan
                                };
                            })
                        };
                    }
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('depositwh/edit_agent_deposit') ?>/' + uid, function(data) {
