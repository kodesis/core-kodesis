			...
			<div class="right_col" role="main">
				...
				<div class="x_panel card">
					...
					<div class="form">
						<?php
						if ($this->uri->segment(3) == null) { ?>
							<form method="POST" action="<?= base_url('cabang/proses_tambah_cabang') ?>">
								<div class="row" style="margin-bottom: 10px;">
									<div class="col-md-6" style="margin-bottom: 10px;">
										<label for="no_urut">Nama Cabang</label>
										<input type="text" class="form-control" name="nama_cabang" id="nama_cabang">
									</div>
									<div class="col-md-6" style="margin-bottom: 10px;">
										<label for="nominal">Alamat Cabang</label>
										<textarea class="form-control" name="alamat_cabang" id="alamat_cabang"></textarea>
									</div>
								</div>
						...
						?>
							<form method="POST" action="<?= base_url('cabang/proses_update_cabang') ?>">
								<input type="hidden" name="id_cabang" id="id_cabang" value="<?= $detail->uid ?>">
								<div class="row" style="margin-bottom: 10px;">
									<div class="row" style="margin-bottom: 10px;">
										<div class="col-md-6" style="margin-bottom: 10px;">
											<label for="no_urut">Nama Cabang</label>
											<input type="text" class="form-control" name="nama_cabang" id="nama_cabang" value="<?= $detail->nama_cabang ?>">
										</div>
										<div class="col-md-6" style="margin-bottom: 10px;">
											<label for="nominal">Alamat Cabang</label>
											<textarea class="form-control" name="alamat_cabang" id="alamat_cabang"><?= $detail->alamat_cabang ?></textarea>
										</div>
									</div>
								</div>
								<button type="submit" class="btn btn-primary">Submit</button>
