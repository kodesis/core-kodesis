        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/store_agent_deposit') ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_agent" id="nama_agent_i" placeholder="Nama">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="alamat_agent" id="alamat_agent_i" placeholder="Alamat">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="telepon_agent" id="telepon_agent_i" placeholder="Telepon">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select name="pic_agent" id="pic_agent_i" class="form-control select2-pic-agent">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("outgoinghlp/getData_agents_deposit") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $('.select2-pic-agent').select2({
                placeholder: ':: Pilih Agent',
                allowClear: true,
                dropdownParent: $('#tambahCustomer .modal-content'),
                ajax: {
                    url: '<?= base_url("outgoinghlp/get_users") ?>', // Mengarah ke method controller baru
                    type: 'POST',
                    dataType: 'json',
                    delay: 250,
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('outgoinghlp/edit_agent_deposit') ?>/' + uid, function(data) {
                    console.log('masuk url edit');

                    console.log(data);

                    $('#uid_i').val(data.uid);
                    $('#nama_agent_i').val(data.nama);
                    $('#alamat_agent_i').val(data.alamat);
                    $('#telepon_agent_i').val(data.telepon);
                    $('#pic_agent_i').append(
                        new Option(data.nama_pic, data.user_pic, true, true)
                    ).trigger('change');
