        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/store_deposit') ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tanggal_deposit" id="tanggal_deposit_i" placeholder="Tanggal Deposit">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="nominal_topup" id="nominal_topup_i" placeholder="Nominal">
                                    </div>
                                </div>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="modalRekap">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/rekap_deposit') ?>">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select name="agent_deposit" id="rekap_agent_deposit" class="form-control select2-nama-rekap">
    ...
    <script>
        $(document).ready(function() {
            ...
            var tableUtama = $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("outgoinghlp/getData_deposit") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                        visible: false,
            ...
            function initOrReloadTableDetail(agent_uid, termasuk_usage) {
                ...
                tableDetail = $('#sub_table_riwayat').DataTable({
                    ...
                    "ajax": {
                        "url": "<?= base_url('outgoinghlp/get_detail_topup_dt') ?>",
                        "type": "POST",
                        "data": function(d) {
