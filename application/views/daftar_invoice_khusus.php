        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="modalDetailInvoice">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/update_invoice_khusus') ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="invoice_num" id="inv_invoice_num" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">No. Invoice</label>
                                        <input type="text" class="form-control" name="no_invoice" id="inv_no_invoice" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="adm" id="inv_adm_input" value="0" readonly>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="modalRekap">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/rekap_invoice_khusus') ?>">
                        <div class="modal-body">
                            <div class="row">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table tbody').on('click', 'tr', function(e) {
                ...
                $.ajax({
                    url: '<?= base_url('outgoinghlp/get_detail_invoice_khusus') ?>/' + uid,
                    type: 'GET',
                    dataType: 'json',
            ...
            $(document).on('click', '.btn-batal-smu', function() {
                ...
                $.ajax({
                    url: '<?= base_url('outgoinghlp/batal_smu_invoice_khusus') ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: {
                        uid_smu: uid_smu,
            ...
            $('#modalDetailInvoice').on('shown.bs.modal', function() {
                ...
                $('.select2-catg-inv').select2({
                    ...
                    dropdownParent: $('#modalDetailInvoice .modal-content'),
                    ajax: {
                        url: '<?= base_url('outgoinghlp/get_bill_catg_inv_khusus') ?>',
                        type: 'POST',
                        dataType: 'json',
                        delay: 250,
                        data: function(params) {
