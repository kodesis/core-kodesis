        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/store_kategori_harga') ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("outgoinghlp/getData_kategori_harga") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('outgoinghlp/edit_kategori_harga') ?>/' + uid, function(data) {
                    ...
                    $('#myModalLabel').text('Edit Daftar Kategori Harga');
