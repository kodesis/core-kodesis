                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel card">
                            <div class="x_title">
                                <h2>Daftar Kategori Harga Invoice Khusus</h2>
        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/store_kategori_harga_khusus') ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Jenis Billing</label>
                                        <select class="form-control" name="jenis_billing" id="jenis_billing_i">
                                            <option value="">Pilih Jenis Billing</option>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Nama Billing</label>
                                        <input type="text" class="form-control" name="nama_billing" id="nama_billing_i" placeholder="Nama Billing">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="csc" id="csc_i" placeholder="CSC">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="cdc" id="cdc_i" placeholder="CDC">
                                    </div>
                                </div>

                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">KADE</label>
                                        <input type="text" class="form-control" name="kade" id="kade_i" placeholder="KADE">
                                    </div>
                                </div>

                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Sewa Gudang</label>
                                        <input type="text" class="form-control" name="sewa_gudang" id="sewa_gudang_i" placeholder="Sewa Gudang">
                                    </div>
                                </div>

                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Jasa RA</label>
                                        <input type="text" class="form-control" name="jasa_ra" id="jasa_ra_i" placeholder="Jasa RA" value="0">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">PPN GDG</label>
                                        <input type="text" class="form-control" name="ppn_gdg" id="ppn_gdg_i" placeholder="PPN GDG" value="0">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">PPN RA</label>
                                        <input type="text" class="form-control" name="ppn_ra" id="ppn_ra_i" placeholder="PPN RA" value="0">
                                    </div>
                                </div>
                                <!-- <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">NPWP</label>
                                        <input type="text" class="form-control" name="npwp" placeholder="0">
                                    </div>
                                </div> -->
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("outgoinghlp/getData_kategori_harga_khusus") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('outgoinghlp/edit_kategori_harga_khusus') ?>/' + uid, function(data) {
                    console.log('masuk url edit');

                    console.log(data);

                    $('#uid_i').val(data.uid);
                    $('#jenis_billing_i').val(data.jenis_billing);
                    $('#nama_billing_i').val(data.nama_billing);
                    $('#csc_i').val(data.csc);
                    $('#cdc_i').val(data.cdc);
                    $('#kade_i').val(data.kade);
                    $('#sewa_gudang_i').val(data.sewa_gudang);
                    $('#jasa_ra_i').val(data.jasa_ra);

                    $('#ppn_gdg_i').val(data.ppn_gdg);
                    $('#ppn_ra_i').val(data.ppn_ra);

                    $('#myModalLabel').text('Edit Daftar Kategori Harga Invoice Khusus');
