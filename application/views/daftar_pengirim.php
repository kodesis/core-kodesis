        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/store_pengirim') ?>">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kode_pengirim" value="<?= $kode ?>" readonly>
                                    </div>
                                </div> -->
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_pengirim" id="nama_pengirim_i" placeholder="Nama">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="alamat_pengirim" id="alamat_pengirim_i" placeholder="Alamat">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="telepon_pengirim" id="telepon_pengirim_i" placeholder="Telepon">
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("outgoinghlp/getData_pengirim") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('outgoinghlp/edit_pengirim') ?>/' + uid, function(data) {
                    console.log('masuk url edit');

                    console.log(data);

                    $('#uid_i').val(data.uid);
                    $('#nama_pengirim_i').val(data.nama);
                    $('#alamat_pengirim_i').val(data.alamat);
                    $('#telepon_pengirim_i').val(data.telepon);

                    $('#myModalLabel').text('Edit Daftar Pengirim');
