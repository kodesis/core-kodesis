        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/store_truck') ?>">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kode_truck" value="<?= $kode ?>" readonly>
                                    </div>
                                </div> -->
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_truck" id="nama_truck_i" placeholder="Merek">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="alamat_truck" id="alamat_truck_i" placeholder="No Polisi">
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("outgoinghlp/getData_truck") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('outgoinghlp/edit_truck') ?>/' + uid, function(data) {
                    console.log('masuk url edit');

                    console.log(data);

                    $('#uid_i').val(data.uid);
                    $('#nama_truck_i').val(data.merk);
                    $('#alamat_truck_i').val(data.no_polisi);
