        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('outgoinghlp/store_tujuan') ?>">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kode_tujuan" value="<?= $kode ?>" readonly>
                                    </div>
                                </div> -->
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kode_kota_tujuan" id="kode_kota_tujuan_i" placeholder="Kode Kota">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Nama Tujuan</label>
                                        <input type="text" class="form-control" name="nama_tujuan" id="nama_tujuan_i" placeholder="Nama">
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("outgoinghlp/getData_tujuan") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('outgoinghlp/edit_tujuan') ?>/' + uid, function(data) {
                    console.log('masuk url edit');

                    console.log(data);

                    $('#uid_i').val(data.uid);
                    $('#nama_tujuan_i').val(data.nama);
                    $('#kode_kota_tujuan_i').val(data.kode_kota);

                    $('#myModalLabel').text('Edit Daftar Tujuan');
