        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('incominghlp/store_agent_deposit') ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("incominghlp/getData_agents_deposit") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $('.select2-pic-agent').select2({
                ...
                ajax: {
                    url: '<?= base_url("incominghlp/get_users") ?>', // Mengarah ke method controller baru
                    type: 'POST',
                    dataType: 'json',
                    delay: 250,
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('incominghlp/edit_agent_deposit') ?>/' + uid, function(data) {
