        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('incominghlp/store_asal') ?>">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kode_asal" value="<?= $kode ?>" readonly>
                                    </div>
                                </div> -->
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kode_kota_asal" id="kode_kota_asal_i" placeholder="Kode Kota">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Nama Asal</label>
                                        <input type="text" class="form-control" name="nama_asal" id="nama_asal_i" placeholder="Nama">
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("incominghlp/getData_asal") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('incominghlp/edit_asal') ?>/' + uid, function(data) {
                    console.log('masuk url edit');

                    console.log(data);

                    $('#uid_i').val(data.uid);
                    $('#nama_asal_i').val(data.nama);
                    $('#kode_kota_asal_i').val(data.kode_kota);

                    $('#myModalLabel').text('Edit Daftar Asal');
