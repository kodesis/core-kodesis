        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('incominghlp/store_deposit') ?>">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="modalRekap">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('incominghlp/rekap_deposit') ?>">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            var tableUtama = $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("incominghlp/getData_deposit") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                        visible: false,
            ...
            function initOrReloadTableDetail(agent_uid, termasuk_usage) {
                ...
                tableDetail = $('#sub_table_riwayat').DataTable({
                    ...
                    "ajax": {
                        "url": "<?= base_url('incominghlp/get_detail_topup_dt') ?>",
                        "type": "POST",
                        "data": function(d) {
