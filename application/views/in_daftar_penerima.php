        ...
        <div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tambahCustomer">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="<?= base_url('incominghlp/store_penerima') ?>">
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kode_penerima" value="<?= $kode ?>" readonly>
                                    </div>
                                </div> -->
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_penerima" id="nama_penerima_i" placeholder="Nama">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Nomor Telepon</label>
                                        <input type="text" class="form-control" name="nomor_telepon" id="nomor_telepon_i" placeholder="Nomor Telepon">
                                    </div>
                                </div>
                                <div class="col-md-6 col-xs-12">
                                    <div class="form-group">
                                        <label class="form-label">Alamat</label>
                                        <input type="text" class="form-control" name="alamat" id="alamat_i" placeholder="Alamat">
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#kemasan_table').DataTable({
                ...
                ajax: {
                    url: '<?= base_url("incominghlp/getData_penerima") ?>',
                    type: 'POST'
                },
                columnDefs: [{
                    orderable: false,
            ...
            $(document).on('click', '.btn-edit', function() {
                ...
                $.get('<?= base_url('incominghlp/edit_penerima') ?>/' + uid, function(data) {
                    console.log('masuk url edit');

                    console.log(data);

                    $('#uid_i').val(data.uid);
                    $('#nama_penerima_i').val(data.nama);
                    $('#nomor_telepon_i').val(data.telepon);
                    $('#alamat_i').val(data.alamat);

                    $('#myModalLabel').text('Edit Daftar Penerima');
