...
<body class="nav-md">
	<div class="container body">
								...
								<div class="row">
									<form class="form-horizontal form-label-left" method="POST" action="<?= base_url('financial/invoice') ?>">
										...
										<div class="col-md-3 col-xs-12">
											...
											<button type="button" class="btn btn-success" data-toggle="modal" data-target="#rekapInvoice">
												Report Excel
											</button>
										</div>
									</form>
												...
												foreach ($invoices as $i) : ?>
													<tr>
														...
														<td>
															...
															if ($i['status_bayar'] == '1') {
															?>
																<a href="<?= base_url('financial/cetak_bukti_pembayaran_invoice/' . $i['Id']) ?>" class="badge bg-green" target="_blank" style="vertical-align: top;">
																	Kwitansi
																</a>
															<?php
															} ?>
		...
		<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="rekapInvoice">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="myModalLabel">
					...
					<form class="form-horizontal form-label-left" method="POST" action="<?= base_url('financial/export_excel_invoice') ?>">
						<div class="modal-body">
							<div class="form-group row">
								<div class="col-md-12 col-xs-12">
									<label for="no_invoice" class="form-label">Customer</label>
									<select name="customer_id" id="customer_id" class="form-control select2" style="width: 100%;">
							...
							<div class="form-group row">
								<div class="col-md-6 col-xs-12">
									<label for="nama_customer" class="form-label">Dari</label>
									<input type="date" class="form-control" name="tanggal_dari" placeholder="Masukkan nama customer...">
								</div>
								<div class="col-md-6 col-xs-12">
									<label for="nama_customer" class="form-label">Sampai</label>
									<input type="date" class="form-control" name="tanggal_sampai" placeholder="Masukkan nama customer..." value="<?= date('Y-m-d') ?>">
								</div>
							</div>
						</div>
						<div class="modal-footer">
