								...
								<form class="form-horizontal form-label-left" method="POST" action="<?= base_url('financial/update_invoice/' . $inv['Id']) ?>">
									...
									<div class="form-group row">
										...
										<div class="col-md-1 col-xs-12">
											...
											<div class="checkbox text-end">
												<input type="checkbox" class="icheckbox_flat-green" style="margin-left: 0px;" name="opsi_pph" id="opsi_pph" <?= ($inv['opsi_pph23'] == '1') ? 'checked' : '' ?> value="1">
										...
										<div class="col-md-1 col-xs-12">
											...
											<div class="checkbox text-end">
												<input type="checkbox" class="icheckbox_flat-green" style="margin-left: 0px;" name="opsi_pph_ps4" id="opsi_pph_ps4" <?= ($inv['opsi_pph_ps4'] == '1') ? 'checked' : '' ?> value="1">
											</div>
										</div>
