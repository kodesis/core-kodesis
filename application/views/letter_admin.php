...
<body class="nav-md">
  <div class="container body">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel card">
              <div class="x_title">
                <h2>List Approval Admin</h2>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <div style="margin-bottom:30px">
                  <a href="<?= base_url('letter/list') ?>" class="btn btn-warning"><i class="fa fa-chevron-left" aria-hidden="true"></i> Back</a>
                  <button class="btn btn-success" data-toggle="modal" data-target="#reportLetter"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Report</button>
                </div>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <?php if ($value['status_admin'] == 0) { ?>
                              <a class="aksi badge badge-success" onclick="update_admin(<?= $value['id_letter'] ?>)">
    ...
    <div class="modal fade" id="modal-update-admin">
      <div class="modal-dialog modal-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?= base_url('letter/update_admin/') ?>" id="form-update-admin" method="post">
              <div class="form-group">
                <input type="hidden" readonly class="form-control" id="id_surat" name="id_surat">
              </div>
              <div class="form-group" id="error_jenis">
                ...
                <span id="err_status_admin" class="text-danger"></span>
              </div>
              <div class="form-group">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btn-update-admin"><i class="fa fa-paper-plane" aria-hidden="true"></i> Update</button>
              </div>
            </form>
          </div>
        </div>
    ...
    <!-- Modal Report Letter -->
    <div class="modal fade " id="reportLetter">
      <div class="modal-dialog modal-centered">
        <div class="modal-content">
          <!-- header-->
          <div class="modal-header">
            <button class="close" data-dismiss="modal"><span>&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">Report Letter</h4>
          </div>
          <!--body-->
          <div class="modal-body">
            <form action="<?= base_url('letter/report') ?>" id="report-letter" method="post">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="perusahaan" id="perusahaan" class="form-control">
                      <?php
                      $perusahaan = $this->db->get('perusahaan')->result_array();
                      foreach ($perusahaan as $row) {
                      ?>
                        <option value="<?= $row['kode'] ?>"><?= $row['perusahaan'] . "(" . $row['kode'] . ")" ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btn-report">Report</button>
              </div>
            </form>
          </div>
        </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#btn-update-admin").click(function(e) {
          e.preventDefault();
          Swal.fire({
            icon: 'warning',
            ...
            if (result.isConfirmed) {
              var url = $("#form-update-admin").attr('action');
              var formData = new FormData($("form#form-update-admin")[0]);
