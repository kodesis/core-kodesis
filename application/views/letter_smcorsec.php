...
<body class="nav-md">
  <div class="container body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <?php if ($value['status_sm_corsec'] == 0) { ?>
                              <a class="aksi badge badge-success" onclick="update_smcorsec(<?= $value['id_letter'] ?>)">
    ...
    <div class="modal fade" id="modal-update-smcorsec">
      <div class="modal-dialog modal-centered">
        <div class="modal-content">
          <!-- header-->
          <div class="modal-header">
            <button class="close" data-dismiss="modal"><span>&times;</span></button>
            <h4 class="modal-title" id="myModalLabel">Update SM Corsec</h4>
          </div>
          <!--body-->
          <div class="modal-body">
            <form action="<?= base_url('letter/update_smcorsec/') ?>" id="form-update-smcorsec" method="post">
              <div class="form-group">
                <input type="hidden" readonly class="form-control" id="id_surat" name="id_surat">
              </div>
              <div class="form-group" id="error_jenis">
                <label for="status_surat">Date</label>
                <input type="date" class="form-control" name="date" id="date">
                <span id="err_status_admin" class="text-danger"></span>
              </div>
              <div c <div class="form-group" id="error_jenis">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btn-update-smcorsec"><i class="fa fa-paper-plane" aria-hidden="true"></i> Update</button>
              </div>
            </form>
          </div>
        </div>
    ...
    <script>
      $(document).ready(function() {
        ...
        $("#btn-update-smcorsec").click(function(e) {
          e.preventDefault();
          Swal.fire({
            icon: 'warning',
            ...
            if (result.isConfirmed) {
              var url = $("#form-update-smcorsec").attr('action');
              var formData = new FormData($("form#form-update-smcorsec")[0]);
    ...
    <script>
      function update_smcorsec(id) {
        $('#modal-update-smcorsec').modal('show');
        $('#id_surat').val(id);
      }
    </script>
</body>
