  ...
  <div class="page-content">
    <div class="card card-style">
      <div class="content mb-0">
        ...
        ?>
        <form action="<?= base_url('mobile/auth/change') ?>" class="my-3" enctype="multipart/form-data" id="form-memo" method="post">
          ...
          <div>
            <a href="<?= base_url('mobile/home') ?>" class="btn btn-warning">Back</a>
