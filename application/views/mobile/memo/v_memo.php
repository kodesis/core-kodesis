            ...
            <table>
                ...
                <?php if (($this->session->userdata('level_jabatan') >= 1) and ($memo->nip_dari <> $this->session->userdata('nip'))) { ?>
                    <tr width="100%">
                        ...
                        <td style="text-align:right">
                            <form action="<?php echo base_url() . "mobile/app/create_memo_approve/" . $memo->Id . "/x"; ?>" target="">
                                <button type="submit" class="btn btn-primary"><i class="fa-solid fa-reply"></i></button>
                            </form>
                        </td>
                        <td style="text-align:right">
                            <form action="<?php echo base_url() . "mobile/app/create_memo_approve/" . $memo->Id; ?>" target="">
                                <button type="submit" class="btn btn-primary"><i class="fa fa-reply-all" aria-hidden="true"></i></button>
                            </form>
                        </td>
                        <td style="text-align:right"><a href="<?= base_url('mobile/app/memo_pdf/' . $memo->Id) ?>" class="btn btn-success" target="_blank"><i class="fa fa-print" aria-hidden="true"></i></a></td>
                    </tr>
                <?php } else { ?>
