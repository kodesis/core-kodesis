    ...
    <div class="content mt-0 mb-3">
      <?php if ($this->uri->segment(4) == false) {  ?>
        ...
        <div class="col-md-4 text-center">
          <a href="<?= base_url('mobile/task/task') ?>" class="btn btn-warning"> <i class="fa fa-arrow-left"></i> Back</a>
          <?php
          ...
          if ($cek_role == true && $cek_status['activity'] == '1') { ?>
            <a href="<?= base_url('mobile/task/detail_task/' . $this->uri->segment(3)) ?>" class="btn btn-primary"> <i class="fa fa-plus"></i> Add Card</a>
          <?php } ?>
          <?php
          if ($cek_status['activity'] == '1' && $cek_role == true) { ?>
            <a href="<?= base_url('mobile/task/close_task/' . $this->uri->segment(3)) ?>" class="btn btn-danger" id="btn-close-task"> Close Task</a>
          <?php } ?>
        </div>
      <?php } ?>
      ...
      ?>
            ...
            <div class="content">
              <div class="text-end">
                <?php if ($x->responsible == $nip || $cek_status['pic'] == $nip) { ?>
                  <a href="<?= base_url('mobile/task/card_edit/' . $this->uri->segment(3) . '/' . $x->id_detail) ?>" class="badge gradient-green"><i class="fa fa-pencil"></i> Update</a>
                <?php } ?>
              </div>
              ...
              <div class="text-start">
                <p class="mb-0 my-2"
                  ...
                  onclick="location.href='<?= base_url('mobile/task/task_view/' . $this->uri->segment(3) . '/' . $x->id_detail) ?>'">
                  <?php
              ...
              <div class="d-flex">
                <div class="flex-grow-1">
                  <p class="mb-n1" style="font-weight: <?= preg_match("/$nip/i", $x->read ?? '') ? '' : 'bolder' ?>; cursor:pointer" onclick="location.href='<?= base_url('mobile/task/task_view/' . $this->uri->segment(3) . '/' . $x->id_detail) ?>'"><?= $x->task_name ?></p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="item form-group">
          <div class="row">
            <div class="col-md-4">
              <a href="<?= base_url('mobile/task/task_view/' . $this->uri->segment(3)) ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
          </div>
        </div>
