...
<div id="menu-main" class="menu menu-box-left rounded-0" data-menu-width="280">
    ...
    ?>
        ...
        <div class="list-group list-custom-small list-menu">
            <a id="nav-welcome" href="<?= base_url('mobile/app/create_memo') ?>">
                <!-- <i class="fa fa-solid fa-inbox gradient-blue color-white"></i> -->
                <i class="fa-solid fa-plus gradient-blue color-white"></i>
                <span>Create</span>
                <i class="fa fa-angle-right"></i>
            </a>
            <a id="nav-welcome" href="<?= base_url('mobile/app/inbox') ?>">
                <i class="fa fa-solid fa-inbox gradient-blue color-white"></i>
                <span>Inbox</span>
                <i class="fa fa-angle-right"></i>
            </a>
            <a id="nav-welcome" href="<?= base_url('mobile/app/outbox') ?>">
    ...
    if (strpos($a, '60') !== false) { ?>
        ...
        <div class="list-group list-custom-small list-menu">
            <a id="nav-welcome" href="<?= base_url('mobile/absensi/absen_list') ?>">
                <i class="fa-solid fa-list gradient-blue color-white"></i>
                <span>Absensi List</span>
                <i class="fa fa-angle-right"></i>
            </a>
            <a id="nav-welcome" href="<?= base_url('mobile/absensi/absen_wfa') ?>">
                <i class="fa-solid fa-list gradient-blue color-white"></i>
                <span>Absensi WFA</span>
                <i class="fa fa-angle-right"></i>
            </a>
            <a id="nav-welcome" href="<?= base_url('mobile/absensi/user_photo') ?>">
                <i class="fa-solid fa-list gradient-blue color-white"></i>
    ...
    <div class="list-group list-custom-small list-menu">
        <a id="nav-welcome" href="<?= base_url('mobile/auth/password') ?>">
