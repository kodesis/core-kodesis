...
<head>
  ...
  <!-- datatable -->
  <link rel="stylesheet" href="<?= base_url('src/dataTables/css/dataTables.dataTables.min.css') ?>">
  <style>
    .col-xs-3 {
      width: 25%;
...
<body class="nav-md">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel card">
              <div class="x_title">
                <h2>List Penyusutan</h2>
              </div>
              <div class="row">
                <div class="col-md-4">
                  <a href="<?= base_url('asset/penyusutan') ?>" class="btn btn-primary btn-penyusutan">Proses Penyusutan</a>
                </div>
              </div>
              <div class="x_content">
                <div class="table-responsive">
                  <table class="table table-bordered" id="tablePenyusutan">
                    <thead>
                      <tr>
  ...
  <!-- Datatable -->
  <script src="<?= base_url('src/dataTables/js/dataTables.min.js') ?>"></script>
  <script>
    $(document).ready(function() {
      $('#tablePenyusutan').DataTable({
        "processing": true,
        "serverSide": true,
        "order": [],
        "ajax": {
          "url": "<?= base_url('asset/penyusutan_ajax_list') ?>",
          "type": "POST",
