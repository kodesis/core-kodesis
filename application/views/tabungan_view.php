            ...
            <div class="right_col" role="main">
                ...
                <div class="x_panel card" id="user">
                    ...
                    <div class="text-center">
                        <a href="<?= base_url('tabungan/create') ?>" class="btn btn-primary">Create</a>
                    </div>
                        ...
                        <table id="table1" class="table table-striped" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th bgcolor="#34495e">
                                        <font color="white">No Tabungan</font>
                                    </th>
                                    <th bgcolor="#34495e">
                                        <font color="white">No CIB</font>
                                    </th>
                                    <th bgcolor="#34495e">
                                        <font color="white">Jenis Tabungan</font>
                                    </th>
                                    <th bgcolor="#34495e">
                                        <font color="white">Status Tabungan</font>
                                    </th>
                                    <th bgcolor="#34495e">
                                        <font color="white">No Urut</font>
                                    </th>
                                    <th bgcolor="#34495e">
                                        <font color="white">Nominal</font>
                                    </th>
                                    <th bgcolor="#34495e">
                                        <font color="white">Spread Rate</font>
                                    </th>
                                    <th bgcolor="#34495e">
                                        <font color="white">Nominal Blokir</font>
                                    </th>
                                    <th bgcolor="#34495e">
                                        <font color="white">Pos Rate</font>
                                    </th>
                                    <th bgcolor="#34495e">
                                        <font color="white">NOLSP</font>
                                    </th>
                                    <th bgcolor="#34495e">
                ...
                function onDelete(id) {
                    ...
                    swalWithBootstrapButtons.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                url: "<?php echo site_url('tabungan/delete') ?>",
                                type: "POST",
                                data: {
                                    id_delete: id
                                },
