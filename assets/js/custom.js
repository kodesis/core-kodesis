...
document.addEventListener("DOMContentLoaded", () => {
	...
	var pwaName = "BOC"; //Local Storage Names for PWA
	...
	function init_template() {
		...
		function highlightColors() {
			...
			if (rememberHighlight) {
				...
				loadHighlight.type = "text/css";
				loadHighlight.href =
					"css/highlights/highlight_" + rememberHighlight + ".css";
		...
		function checkDarkMode() {
			...
			darkModeSwitch.forEach((el) =>
				el.addEventListener("click", (e) => {
					...
					var logoBandes = document.getElementById("logo-bandes");
					var logoBandes2 = document.getElementById("logo-bandes2");
					var logoLogin = document.getElementById("logo-login");
					if (document.body.className == "theme-light") {
						removeTransitions();
						activateDarkMode();
						logoBandes.src = baseUrl + "assets/images/logo-white.png";
						logoBandes2.src = baseUrl + "assets/images/logo-white.png";
						logoLogin.src = baseUrl + "assets/images/logo_bdl.png";
					} else if (document.body.className == "theme-dark") {
						removeTransitions();
						activateLightMode();
						logoBandes.src = baseUrl + "assets/images/logo-black.png";
						logoBandes2.src = baseUrl + "assets/images/logo-black.png";
						logoLogin.src = baseUrl + "assets/images/logo2.png";
					}
					setTimeout(function () {
						addTransitions();
					}, 350);
		...
		if (footerBar6) {
		    ...
		    // Check if .active-nav exists before proceeding
		    if (footerBar6_select) {
		        footerBar6_select.insertAdjacentHTML("beforeend", "<em></em>");
		    }
		
		    // Check if .circle-nav exists before proceeding
