...
(function () {
				...
				on: function (b, d, h, k, g) {
					...
					if (0 > e.getListenerIndex(d)) {
						...
						for (var w = e.length - 1; 0 <= w; w--)
							if (e[w].priority <= g)
								return e.splice(w + 1, 0, l), { removeListener: v };
						e.unshift(l);
					}
		...
		function a(a, w, b) {
			...
			this.input = function () {
				...
				if (!c._scheduledTimer || !1 !== c._reschedule()) {
					...
					z < c._minInterval
						? (c._scheduledTimer = setTimeout(a, c._minInterval - z))
						: a();
				}
			};
		}
		...
		CKEDITOR.tools = {
			...
			parseCssText: function (a, b, c) {
				...
				a.replace(/&quot;/g, '"').replace(
					...
					function (a, c, z) {
						b &&
							((c = c.toLowerCase()),
							"font-family" == c && (z = z.replace(/\s*,\s*/g, ",")),
							(z = CKEDITOR.tools.trim(z)));
						e[c] = z;
					}
				);
				return e;
			...
			enableHtml5Elements: function (a, b) {
				for (
					...
					(g = a.createElement(c[e])), b && a.appendChild(g);
			},
			...
			keystrokeToArray: function (a, b) {
				...
				e &&
					(a[e]
						? (m.push(a[e]), d.push(a[e]))
						: (m.push(String.fromCharCode(e)), d.push(String.fromCharCode(e))));
			...
			getCookie: function (a) {
				...
				for (var b = document.cookie.split(";"), c, e, g = 0; g < b.length; g++)
					if (
						((c = b[g].split("\x3d")),
						(e = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase())),
						e === a)
					)
			...
			getCsrfToken: function () {
				...
				if (!a || 40 != a.length) {
					...
					for (c = 0; c < a.length; c++)
						var e = "abcdefghijklmnopqrstuvwxyz0123456789".charAt(a[c] % 36),
							b = b + (0.5 < Math.random() ? e.toUpperCase() : e);
					a = b;
			...
			object: {
				...
				merge: function (a, b) {
					...
					c.array.forEach(c.object.keys(g), function (a) {
						e[a] =
							"object" === typeof g[a] && "object" === typeof e[a]
								? c.object.merge(e[a], g[a])
								: g[a];
					});
					return e;
				},
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
				...
				if (
					...
					k &&
						...
						(CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
							...
							: ((c = w ? d.$ : h), (b = c.scrollLeft), (c = c.scrollTop)),
						(b = f.left + b - m),
						(c = f.top + c - u));
				} else
					for (
			...
			scrollIntoParent: function (a, b, c) {
				...
				function u(a, b) {
					...
					e = a.getWindow();
					e.equals(b) ||
						((e = u(CKEDITOR.dom.element.get(e.$.frameElement), b)),
						(c.x += e.x),
						(c.y += e.y));
					return c;
				}
				...
				a instanceof CKEDITOR.dom.window &&
					(a = k ? w.getBody() : w.getDocumentElement());
				CKEDITOR.env.webkit &&
					(w = this.getEditor(!1)) &&
			...
			copyAttributes: function (a, b) {
				...
				for (var e = 0; e < c.length; e++) {
					var d = c[e],
						...
						f;
					if (!(w in b))
						if ("checked" == w && (f = this.getAttribute(w)))
							a.setAttribute(w, f);
						else if (!CKEDITOR.env.ie || this.hasAttribute(w))
							(f = this.getAttribute(w)),
	...
	(function () {
		...
		function d(a, b, c, d, f) {
			...
			if (
				...
				(n.equals(C) ||
					(n.type === CKEDITOR.NODE_ELEMENT && n.getFirst().equals(C)))
			)
				c.append(a.document.createText(C.substring(L, B)));
			else {
				C.type == CKEDITOR.NODE_TEXT
					? l
						? (T = !0)
				...
				for (
					...
					K = ba.getNext();
					for (
						U != I || (ba.equals(t[U]) && I < p)
							? b && (E = J.append(ba.clone(0, f)))
							: N
							? h(ba, J, !1, D)
							: x && J.append(a.document.createText(ba.substring(L)));
						K;
				...
				J = c;
				for (U = P; U <= p; U++)
					if (((c = t[U]), (K = c.getPrevious()), c.equals(S[U])))
						b && (J = J.getChild(0));
					else {
						U != p || (c.equals(S[U]) && p < I)
							? b && (E = J.append(c.clone(0, f)))
							: q
							? h(c, J, !1, r)
							: T && J.append(a.document.createText(c.substring(0, B)));
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						B.type == CKEDITOR.NODE_TEXT
							? (q &&
									...
									(L = !!B)),
							  B && ((n = B.getPrevious()) || (l = B.getParent())))
							: (q && (n = B.getChild(q - 1) || B.getLast()), n || (l = B));
						for (l = c(l); l || n; ) {
							if (l && !n) {
								!C && l.equals(m) && (C = !0);
								if (f ? l.isBlockBoundary() : !g.contains(l)) break;
								(L && "inline" == l.getComputedStyle("display")) ||
									((L = !1), C ? (k = l) : this.setStartBefore(l));
								n = l.getPrevious();
							}
							for (; n; )
								if (((B = !1), n.type == CKEDITOR.NODE_COMMENT))
									n = n.getPrevious();
								else {
									if (n.type == CKEDITOR.NODE_TEXT)
										...
										(n.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) ||
											(b && n.is("br"))) &&
										!n.data("cke-bookmark")
									)
										if (L && CKEDITOR.dtd.$removeEmpty[n.getName()]) {
											...
											if (d.test(N)) n = null;
												...
												for (
													var q = n.$.getElementsByTagName("*"), D = 0, r;
													(r = q[D++]);

												)
													if (
														!CKEDITOR.dtd.$removeEmpty[r.nodeName.toLowerCase()]
													) {
														n = null;
														break;
													}
						...
						for (; l || n; ) {
							if (l && !n) {
								...
								if (f ? l.isBlockBoundary() : !g.contains(l)) break;
								(L && "inline" == l.getComputedStyle("display")) ||
									((L = !1), C ? (v = l) : l && this.setEndAfter(l));
								n = l.getNext();
							}
							for (; n; ) {
								B = !1;
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						this.setStartAt(
							x,
							!x.is("br") &&
								((!l && this.checkStartOfBlock()) || (l && x.contains(l)))
						...
						this.setEndAt(
							x,
							(!l && this.checkEndOfBlock()) || (l && x.contains(l))
				...
				return function (b) {
					for (
						var c = this.createBookmark(),
							...
							m = d.block || d.blockLimit,
							f;
						m && !m.equals(d.root) && !m.getFirst(a(m));
		...
		a.prototype = {
			getNextParagraph: function (a) {
				...
				if (!this._.started) {
					...
					u.collapsed ||
						((k = new CKEDITOR.dom.walker(u.clone())),
						...
						(k.evaluator = m),
						(k = k.previous()),
						(this._.lastNode = k.getNextSourceNode(!0, null, u.root)),
						this._.lastNode &&
				...
				if (!d) {
					...
					!m.equals(k.root)
						...
						? (k.checkStartOfBlock() && k.checkEndOfBlock()) ||
						  ...
						  k.insertNode(d))
						: w ||
						  (this._.nextNode = d.equals(u)
								? null
								: this._getNextSourceNode(k.getBoundaryNodes().endNode, 1, u));
				}
				A &&
					(A = d.getPrevious()) &&
					A.type == CKEDITOR.NODE_ELEMENT &&
				...
				this._.nextNode ||
					(this._.nextNode =
						w || d.equals(u) || !u ? null : this._getNextSourceNode(d, 1, u));
				return d;
			},
	...
	(function () {
		function a(a, b, c, d, f) {
			...
			for (e in b) {
				...
				for (q in T) {
					...
					for (P in g)
						"!" == P.charAt(0) &&
							((P = P.slice(1)), x.push(P), (h[P] = !0), (J = !1));
					for (; (P = x.pop()); ) (g[P] = g["!" + P]), delete g["!" + P];
					r[t] = (J ? !1 : h) || null;
				}
					...
					if (
						...
						if (a)
							if (!0 === a) a = !0;
								...
								for (var e = 0, n = c.length, p; e < n; ++e)
									(p = c[e]), f[p] || (f[p] = a(p));
								a = !1;
							}
						else a = !1;
		...
		function H(a, b, c) {
			...
			if (q.$empty[d] || !a.children.length)
				...
				if ("br" == b)
					a.previous && !G(a.previous) && ((b = y()), b.insertBefore(a)),
						a.next && !G(a.next) && ((b = y()), b.insertAfter(a)),
					...
					if (f)
						...
						for (
							var e =
									f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == f.name,
								r,
								m,
								n = d.length;
							0 < n;
							...
							(p = d[--n]),
								...
								(p.type == CKEDITOR.NODE_TEXT ||
									(p.type == CKEDITOR.NODE_ELEMENT && q.$inline[p.name]))
									? (r ||
		...
		function C(a, b) {
			...
			for (e in d)
				if ("class" == e)
					for (
						c = d[e].split(/\s+/), p = a.classes.join("|");
						(r = c.pop());
			...
			for (n in f) if (a.styles[n] != f[n]) return !1;
			return !0;
		}
		function L(a, b) {
			var c, d;
			...
			if (c && !b) {
				...
				!0 === d
					...
					: (d || (this.customConfig = !1),
					  ...
					  this.allow(
							x[c.enterMode] + " " + x[c.shiftEnterMode],
							"default",
							1
					  ),
		...
		CKEDITOR.filter.prototype = {
			...
			applyTo: function (a, b, c, d) {
					...
					function (a) {
						if (a.type == CKEDITOR.NODE_ELEMENT) {
							...
							a: {
								...
								1 == d.children.length &&
									(m = d.children[0]).type == CKEDITOR.NODE_ELEMENT &&
									A(f, m, c, t);
								c = !c.length;
							}
							c || e.push(a);
				...
				for (; (h = a.pop()); )
					if (((c = h.el), c.parent))
						switch (((g = q[c.parent.name] || q.span), h.check)) {
							case "it":
					...
					for (f = 0; f < a.length; ++f) {
						...
						for (n = 0; n < b.length; ++n)
							(p = b[n]),
								...
								m instanceof CKEDITOR.style && (m = B(m)),
								c.push({
									check: r == e ? null : r,
									left: m,
			...
			check: function (a, b, c) {
				...
				if ("string" == typeof a) {
					...
					(f = a.getDefinition()),
						(r = f.styles),
						(d = f.attributes || {}),
						r && !CKEDITOR.tools.isEmpty(r)
							? ((r = D(r)), (d.style = CKEDITOR.tools.writeCssText(r, !0)))
							: (r = {}),
						(f = {
							name: f.element,
							attributes: d,
				...
				if (!1 !== b && (h = this._.transformations[f.name])) {
					for (d = 0; d < h.length; ++d) n(this, f, h[d]);
					u(f);
				}
				A(this, r, m, {
					doFilter: !0,
				...
				0 < m.length
					...
					: ((b = f.attributes["class"]) &&
							(f.attributes["class"] = f.attributes["class"]
								...
								.sort()
								.join(" ")),
					  (c = CKEDITOR.tools.objectCompare(f.attributes, r.attributes, !0)),
			...
			transform: function (a, b) {
				if ("string" == typeof b) a.name = b;
					...
					for (e in f)
						if ("class" == e)
							for (
								c = a.classes.join("|"), p = f[e].split(/\s+/);
								(r = p.pop());
										...
										(8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat)
											? (e.$.onreadystatechange = function () {
													if (
														...
														(e.$.onreadystatechange = null), A(b, !0);
											  })
											: ((e.$.onload = function () {
													setTimeout(function () {
														e.$.onload = null;
						...
						a.call(
							...
							function (a) {
								...
								for (e in a) {
									...
									if (!d[e]) {
										if (g.icons)
											for (var A = g.icons.split(","), F = A.length; F--; )
	...
	(function () {
			...
			CKEDITOR.plugins.load(d.split(","), function (b) {
				...
				for (var n in b) {
					...
					k &&
						...
						0 <= CKEDITOR.tools.indexOf(k, a.langCode)
							? (C = a.langCode)
							: ((C = a.langCode.replace(/-.*/, "")),
							  (C =
									C != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, C)
										? C
										: 0 <= CKEDITOR.tools.indexOf(k, "en")
										? "en"
										: k[0])),
						h.langEntries && h.langEntries[C]
							? ((a.lang[n] = h.langEntries[C]), (C = null))
							: e.push(CKEDITOR.getUrl(h.path + "lang/" + C + ".js")));
					f.push(C);
					d.push(h);
				}
				CKEDITOR.scriptLoader.load(e, function () {
					if (!a.isDestroyed() && !a.isDetached()) {
						for (
							var b = ["beforeInit", "init", "afterInit"], e = 0;
							e < b.length;
							e++
						)
							for (var n = 0; n < d.length; n++) {
								...
								0 === e &&
									...
									r.lang &&
									r.langEntries &&
									(a.lang[r.name] = r.langEntries[f[n]]);
								if (r[b[e]]) r[b[e]](a);
							}
		...
		function A(a, b) {
			...
			for (
				var f = new CKEDITOR.dom.documentFragment(), e, h, g, k = 0;
				k < a.length;
				k++
			) {
				var l = a[k],
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			getCommandKeystroke: function (a, b) {
				...
				if (c) {
					...
					else for (var h in e) e[h] === f && d.push(h);
				}
				return b ? d : d[0] || null;
			},
			addFeature: function (a) {
	...
	(function () {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function (h, k, g) {
			function l(a) {
				...
				if (0 < m.length)
					for (var c = 0; c < m.length; c++) {
						...
						(h && !h[f]) || (a && e && !e[a] && CKEDITOR.dtd[a])
							? f == y.name && (z(y, y.parent, 1), c--)
							: (b || (v(), (b = 1)),
							  (d = d.clone()),
							  (d.parent = y),
							  (y = d),
			...
			function z(b, c, d) {
				...
				var f = y;
				void 0 === b.previous &&
					(w(c, b) && ((y = c), F.onTagOpen(g, {}), (b.returnPoint = c = y)),
					e(b),
							...
							if (y.isOptionalClose) F.onTagClose(h);
								...
								(h = y.children),
									((h = h[h.length - 1]) && "li" == h.name) ||
										z((h = new CKEDITOR.htmlParser.element("li")), y),
									!e.returnPoint && (e.returnPoint = y),
									(y = h);
							else if (f in CKEDITOR.dtd.$listItem && !A(f, h))
								F.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1);
							else if (h in d && !A(f, h))
								!e.returnPoint && (e.returnPoint = y), (y = y.parent);
			...
			F.onText = function (a) {
				if (
					!((y._.hasInlineStarted && !M.length) || H || G) &&
	...
	(function () {
				...
				return function (f) {
					if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var p = [],
							...
							q;
						if (r)
							for (t(r, 1) && p.push(r); r; )
								h(r) &&
									(n = c(r)) &&
									t(n) &&
									((q = c(n)) && !h(q)
										? p.push(n)
										: (e(g).insertAfter(n), n.remove())),
									(r = r.previous);
			...
			function t(a, b) {
				...
				return a.type == CKEDITOR.NODE_TEXT &&
					...
					(c.index &&
						...
						(a.value = c[0])),
					(!CKEDITOR.env.needsBrFiller && g && (!b || a.parent.name in x)) ||
						(!g && (((c = a.previous) && "br" == c.name) || !c || h(c))))
					? !0
					: !1;
			}
			var q = { elements: {} },
			...
			return a.replace(q, function (a, b, c) {
				return (
					...
					c.replace(D, function (a, b) {
						return r.test(b) && -1 == c.indexOf("data-cke-saved-" + b)
			...
			b.on(
				...
				function (a) {
					...
					CKEDITOR.env.ie &&
						9 > CKEDITOR.env.version &&
						"pre" == f &&
						((f = "div"), (c = "\x3cpre\x3e" + c + "\x3c/pre\x3e"), (r = 1));
					...
					f &&
						((r = c),
						!r.children.length &&
							CKEDITOR.dtd[r.name][f] &&
							((f = new CKEDITOR.htmlParser.element(f)), r.add(f)));
					a.dataValue = c;
				},
				null,
				null,
		...
		var M = /(?:&nbsp;|\xa0)$/,
			...
			n = CKEDITOR.tools.extend({}, G.$blockLimit, G.$block),
		...
		CKEDITOR.editor.prototype.setMode = function (a, b) {
			...
			if (a != d.mode && k && k[a]) {
				...
				if (d.mode) {
					...
					"source" == d.mode &&
						k == l &&
						(d.fire("lockSnapshot", { forceUpdate: !0 }), (v = 1));
										  ...
										  f[c ? "checkStartOfBlock" : "checkEndOfBlock"]()
												? (a.fire("saveSnapshot"),
												  f[c ? "checkEndOfBlock" : "checkStartOfBlock"]() &&
														g.remove(),
												  f["moveToElementEdit" + (c ? "End" : "Start")](k),
												  f.select(),
												  a.fire("saveSnapshot"),
												  (d = 1))
												: q.blockLimit &&
												  q.blockLimit.is("td") &&
												  (p = q.blockLimit.getAscendant("table")) &&
												  f.checkBoundaryOfElement(
														p,
														c ? CKEDITOR.START : CKEDITOR.END
												  ) &&
												  (k = p[c ? "getPrevious" : "getNext"](z))
												? (a.fire("saveSnapshot"),
												  f["moveToElementEdit" + (c ? "End" : "Start")](k),
						...
						CKEDITOR.env.gecko &&
							this.attachListener(this, "mouseup", function (b) {
								if (
									2 == b.data.$.button &&
									((b = b.data.getTarget()),
									!b.getAscendant("table") && !b.getOuterHtml().replace(u, ""))
								) {
									var c = a.createRange();
											...
											a: {
												...
												if (
													...
													if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) {
														var t = d.startContainer.getChild(
															d.startOffset - (c ? 1 : 0)
														);
														if (
															t &&
		...
		m = (function () {
			...
			function f(b) {
				return (
					b &&
					a(b) &&
					(b.is(r.$removeEmpty) || (b.is("a") && !b.isBlockBoundary()))
				);
			}
			function q(b, c, d, e) {
				var f = b.clone(),
				...
				(g = new CKEDITOR.dom.walker(f).next()) &&
					...
					(r = g.getPrevious()) &&
					a(r) &&
					!r.getParent().equals(b.startContainer) &&
					d.contains(r) &&
					e.contains(g) &&
					g.isIdentical(r) &&
					(g.moveChildren(r), g.remove(), q(b, c, d, e));
			}
			function h(b, c) {
				function d(b, c) {
					if (
			...
			return function (t, x, I, p) {
				...
				if (!p.checkReadOnly()) {
					var w =
						new CKEDITOR.dom.elementPath(p.startContainer, p.root).blockLimit ||
						p.root;
					x = {
						type: x,
						dontFilter: E,
					...
					"text" == x.type &&
						...
						((z = CKEDITOR.dom.element.createFromHtml(
							"\x3cspan\x3e\x26nbsp;\x3c/span\x3e",
							E.document
						)),
						E.insertNode(z),
					...
					for (; (F = e(E)) && a(F) && F.isBlockBoundary() && A.contains(F); )
						E.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END);
					q(E, x.blockLimit, A, y);
					z && (E.setEndBefore(z), E.collapse(), z.remove());
					z = E.startPath();
					if ((u = z.contains(f, !1, 1)))
						(V = E.splitElement(u)),
							(x.inlineStylesRoot = u),
							(x.inlineStylesPeak = z.lastElement);
					z = E.createBookmark();
					K && (l(u), l(V));
					...
					E.moveToBookmark(z);
					J.enterMode === CKEDITOR.ENTER_DIV &&
						"" === J.getData(!0) &&
						((J = t.getFirst()) && J.remove(),
						p.setStartAt(t, CKEDITOR.POSITION_AFTER_START),
						p.collapse(!0));
					if ((t = I)) {
						t = x.range;
						if ("text" == x.type && x.inlineStylesRoot) {
							...
							for (V = x.inlineStylesRoot.getParent(); !p.equals(V); )
								(J = J.appendTo(p.clone())), (p = p.getParent());
					...
					if (t) {
						...
						var M,
							E = F.getPosition(J),
							w =
								!!F.getCommonAncestor(J) &&
								E != CKEDITOR.POSITION_IDENTICAL &&
								!(
									E &
						...
						for (h(J, Q); V < J.length; V++) {
							...
							if ((K = E.isLineBreak))
								(K = Q),
									...
									E.hasBlockSibling
										? (K = 1)
										: (A = K.startContainer.getAscendant(r.$block, 1)) &&
										  A.is({ div: 1, p: 1 })
										? ((y = A.getPosition(u)),
										  ...
										  y == CKEDITOR.POSITION_CONTAINS
												? (K = 0)
												: ((u = K.splitElement(A)),
												  K.moveToPosition(u, CKEDITOR.POSITION_AFTER_START),
												  (K = 1)))
										: (K = 0);
							if (K) I = 0 < V;
							else {
								K = Q.startPath();
								!E.isBlock &&
									k(x.editor, K.block, K.blockLimit) &&
									(O = g(x.editor)) &&
									((O = t.createElement(O)),
									O.appendBogus(),
									Q.insertNode(O),
									CKEDITOR.env.needsBrFiller &&
										(R = O.getBogus()) &&
										R.remove(),
									Q.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END));
								if ((K = Q.startPath().block) && !K.equals(G)) {
									if ((R = K.getBogus())) R.remove(), W.push(K);
									G = K;
								}
								E.firstNotAllowed && (z = 1);
								if (z && E.isElement) {
									K = Q.startContainer;
									...
									if (K)
										...
										A = [];
										y = u.length;
										for (var aa = 0, ca = void 0, Y = 0, X = -1; aa < y; aa++)
											(ca = u[aa]),
												" " == ca
													? (Y ||
															(M && !aa) ||
															(A.push(new CKEDITOR.dom.text(" ")),
															(X = A.length)),
													  (Y = 1))
													: (A.push(ca), (Y = 0));
										K && X == A.length && A.pop();
								...
								E.lastNotAllowed &&
									V < J.length - 1 &&
									((H = w ? F : H) &&
										Q.setEndAt(H, CKEDITOR.POSITION_AFTER_START),
									(z = 0));
								Q.collapse();
							}
						}
						...
						R &&
							((I = !0),
							(K = J[0].node),
							Q.setStartAt(K, CKEDITOR.POSITION_BEFORE_START),
							Q.setEndAt(K, CKEDITOR.POSITION_AFTER_END));
						x.dontMoveCaret = I;
					...
					for (G = R.createBookmark(); (O = x.zombies.pop()); )
						O.getParent() &&
							((H = R.clone()),
					...
					if (M)
						for (; (O = M.pop()); )
							CKEDITOR.env.needsBrFiller
								? O.appendBogus()
								: O.append(R.document.createText(" "));
					...
					if (!x.dontMoveCaret) {
						for (O = e(R); O && a(O) && !O.is(r.$empty); ) {
							if (O.isBlockBoundary())
								R.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END);
							else {
				...
				table: (function () {
					function a(c) {
						...
						g.guard = function (a, g) {
							...
							if (g && h && a.equals(h))
								...
								(f = c.clone()),
									f.setStartAt(t, CKEDITOR.POSITION_AFTER_START),
									e.push(f);
							else {
								if ((l = !g))
									l =
					...
					return {
						...
						detectRanges: function (e, f) {
							...
							t = l;
							l = new CKEDITOR.dom.elementPath(g.startContainer, t);
							...
							if (l || t)
								l && t && b(l, t)
									? ((e.tableSurroundingRange = h),
									  ...
									  (k = g.clone()),
									  k.setStartAt(t, CKEDITOR.POSITION_BEFORE_START),
									  (k = a(h).concat(a(k))))
									: l
									? t ||
									  ((e.tableSurroundingRange = h),
	...
	(function () {
		...
		CKEDITOR.on("instanceCreated", function (a) {
			...
			c.on("contentDom", function () {
				...
				if (CKEDITOR.env.ie || CKEDITOR.env.gecko || D)
					m
							...
							q.on("mousedown", function (a) {
								function b(a) {
									...
									if (w) {
										...
										w.setEndPoint(
											0 > A.compareEndPoints("StartToStart", c)
												? "EndToEnd"
												: "StartToStart",
											c
										);
				...
				p.attachListener(p, "keydown", F(c), null, null, -1);
			});
					...
					if (this.isLocked) {
						...
						a: {
							...
							if (
								...
								t.type == CKEDITOR.NODE_ELEMENT &&
								((I = I.clone()),
								I.shrink(CKEDITOR.SHRINK_ELEMENT, !0),
								(l = I.getEnclosedNode()) &&
									l.type == CKEDITOR.NODE_ELEMENT &&
									(t = l),
							...
							if (m) {
								...
								k
									? ((t = b.document.$.body.createTextRange()),
									  t.moveToElementText(k.$),
									  E.setEndPoint("EndToEnd", t),
									  E.moveEnd("character", -1))
									: ((p = I.getNext(l)),
									  (n = I.hasAscendant("pre")),
									  (p =
											!(p && p.getText && p.getText().match(t)) &&
											(n ||
												!I.hasPrevious() ||
									  ...
									  n.setHtml("\x26#65279;"),
									  n.insertBefore(I),
									  p && b.document.createText("﻿").insertBefore(I));
								b.setStartBefore(I);
								I.remove();
								a
									? (p
								...
								for (E = 0; E < a.length; E++) {
									if (
										...
										(n = a[E + 1]),
										(t = p.clone()),
										t.setStart(p.endContainer, p.endOffset),
										t.setEnd(n.startContainer, n.startOffset),
										!t.collapsed &&
											(t.shrink(CKEDITOR.NODE_ELEMENT, !0),
											(b = t.getCommonAncestor()),
											(t = t.getEnclosedNode()),
											b.isReadOnly() || (t && t.isReadOnly())))
									) {
									...
									b.collapsed &&
										...
										"br" == p.getName()
											...
											: b.moveToPosition(t, CKEDITOR.POSITION_AFTER_END));
									n.setStart(b.startContainer.$, b.startOffset);
									try {
										n.setEnd(b.endContainer.$, b.endOffset);
									} catch (w) {
										if (0 <= w.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))
											b.collapse(1), n.setEnd(b.endContainer.$, b.endOffset);
										else throw w;
									}
									k.addRange(n);
								}
			...
			if (c.collapsed)
				...
				for (q.getPosition(w) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q; ) {
					...
					if (q.equals(w)) (q = null), (l = !0);
						...
						if (
							(A && q.data("cke-bookmark")) ||
							q.type === CKEDITOR.NODE_COMMENT
						) {
						...
						if (x && m && CKEDITOR.dtd.$block[A])
							for (
								var B = q,
									...
									G = C.length,
									H = 0,
									B = G && new CKEDITOR.dom.range(B.getDocument());
								H < G;
								++H
							) {
								var D = C[H],
								...
								if (L ? L.check(this) : 1)
									B.selectNodeContents(D), b.call(this, B);
							}
						...
						if (C)
							if (
								...
								(H = k),
								!D ||
									(!(D.getDtd() || CKEDITOR.dtd.span)[G] && !H) ||
									(C.parentRule && !C.parentRule(D)))
							)
								l = !0;
							else {
								if (
					...
					if (l && z && !z.collapsed) {
						for (
							...
							if (y.getName() == g) {
								for (Y in h.attributes)
									!G[Y] &&
										(Z = y.getAttribute(X)) &&
										(l.getAttribute(Y) == Z ? (C[Y] = 1) : (G[Y] = 1));
								for (X in h.styles)
									!D[X] &&
										(Z = y.getStyle(X)) &&
										(l.getStyle(X) == Z ? (A[X] = 1) : (D[X] = 1));
							}
							y = y.getParent();
						}
		...
		function A(a, b) {
			...
			for (g in d)
				if (
					...
					a.getAttribute(g) == n(g, d[g])
				)
					(b && "data-" == g.slice(0, 5)) ||
						((f = a.hasAttribute(g)), a.removeAttribute(g));
			for (var h in c)
				(this._.definition.fullMatch && a.getStyle(h) != n(h, c[h], !0)) ||
			...
			for (var f in b)
				if (f != this.element)
					for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)
						(d = c.getItem(e)), d.isReadOnly() || u(d, b[f]);
		}
		function u(a, b, c) {
			if ((b = b && b.attributes))
		...
		CKEDITOR.style.prototype = {
			apply: function (a) {
				if (a instanceof CKEDITOR.dom.document)
					return L.call(this, a.getSelection());
			...
			remove: function (a) {
				if (a instanceof CKEDITOR.dom.document)
					return L.call(this, a.getSelection(), 1);
				if (this.checkApplicable(a.elementPath(), a)) {
					var b = this._.enterMode;
					b || (this._.enterMode = a.activeEnterMode);
				...
				return {
					getNextRange: function (k) {
						...
						if (g && 1 < a.length) {
							...
							for (g.moveToBookmark(d.shift()); v--; )
								(l = a[++h]),
		...
		CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
			...
			proto: {
				...
				render: function (a, b) {
					...
					this._.listeners.push(a.on("activeFilterChange", d, this));
					...
					e = {
						...
						cls: this.className || "",
						titleJs:
							e.gecko && !e.hc ? "" : (this.title || "").replace("'", ""),
						keydownFn: h,
						focusFn: n,
						clickFn: l,
					};
	...
	(function () {
		...
		function W(a) {
			...
			b.on("drop", function (c) {
				...
				if ("" !== f && h === CKEDITOR.DATA_TRANSFER_CROSS_EDITORS) c.cancel();
					...
					if ("" === f && 0 < b.widgets.selected.length)
						c.data.dataTransfer.setData("text/html", F(b));
					else if ((f = a.instances[f]))
						...
						function (b) {
							...
							if ("data-cke-widget-id" in c) {
								if ((c = a.instances[c["data-cke-widget-id"]]))
									(e = b.getFirst(g.isParserWidgetElement)),
										f.push({
											wrapper: b,
											element: e,
											widget: c,
			...
			b.on(
				...
				function (a) {
					if (a.data.downcastingSessionId)
						for (
							var b = c[a.data.downcastingSessionId], f, h, l, k, g, m;
							(f = b.shift());
							...
							for (m in f.editables)
								(g = f.editables[m]),
									...
									g.setHtml(h.editables[m].getData());
							k || (k = l);
		...
		function H(a) {
			...
			return {
				...
				commit: function () {
					...
					for (f && (h = a.focused) && x(a, h); (h = d.pop()); )
						b.splice(CKEDITOR.tools.indexOf(b, h), 1),
							h.isInited() &&
								((l = h.editor.checkDirty()),
								h.setSelected(!1),
								!l && h.editor.resetDirty());
					f &&
						e &&
		...
		function O(a) {
			if (!0 === a.mask) ma(a);
				...
				for (var h in a.editables)
					a.editables[h].on("focus", function () {
